...
public class CarTest {
    public static void main(String[] args) {
        ...
        //Then complete the method getTotalWeight in the Car class. This should be the sum of all car parts.
        //Use case: A car weighs one ton, a wheel 100kg and a door 150kg.
        // Assuming, a car has four doors and four wheels, we expect
